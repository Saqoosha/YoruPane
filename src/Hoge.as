...
},{"./../lib/Modernizr":3,"./../lib/prefixed":20}],30:[function(require,module,exports){
var Modernizr = require('./../lib/Modernizr');
...
},{"./../lib/Modernizr":3}],31:[function(require,module,exports){
var BaseApp, Modernizr, Rectangle, SVGApp, Snap, mina, _ref,
...
_ref = require('svapsvg'), Snap = _ref.Snap, mina = _ref.mina;
...
SVGApp = (function() {
  function SVGApp() {
    ...
    mtx = Snap.matrix();
    mtx.translate(Math.round((document.body.clientWidth - 950) / 2), Math.round(this.navi.getBoundingClientRect().top));
    this.g = this.paper.g().attr({
      transform: mtx.toTransformString()
    });
    this.dots = {};
    this.inner = new Rectangle(0, 0, 950, 600);
    this.inner.inflate(-100, -100);
    setInterval(this.resize, 500);
  }

  SVGApp.prototype.resize = function() {
    var mtx;
    this.paper.attr({
  ...
  SVGApp.prototype.getInfo = function() {
    return [Math.round((document.body.clientWidth - 950) / 2), Math.round(this.navi.getBoundingClientRect().top), window.innerWidth, window.innerHeight];
  };
  ...
  SVGApp.prototype.update = function(info) {
    var arg, d, op, p, _i, _len, _ref1, _results;
    if (this.hidden) {
      return;
    }
    _results = [];
    for (_i = 0, _len = info.length; _i < _len; _i++) {
      _ref1 = info[_i], op = _ref1.op, arg = _ref1.arg;
      switch (op) {
        case 'new':
          if (!this.inner.contains([arg.x, arg.y])) {
            p = arg.from || arg;
        ...
        case 'move':
          ...
          if (d) {
            ...
            if (!arg.destroy) {
              arg.destroy = this.inner.contains([arg.x, arg.y]);
            }
            setTimeout(this.animate, arg.delay * 1000, d, arg);
            if (!arg.destroy) {
              _results.push(this.dots[arg.id] = d);
          ...
          } else if (!arg.destroy && !this.inner.contains([arg.x, arg.y])) {
...
window.dotgen = Modernizr.svg && Modernizr.raf ? new SVGApp() : new BaseApp();


},{"browsernizr":2,"browsernizr/test/requestanimationframe":29,"browsernizr/test/svg":30,"svapsvg":1}]},{},[31]);
